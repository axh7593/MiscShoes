...
// get all sale item data from the table 
    ...
    function addToCart(){
        ...
        if(isset($_POST['id'])){
           ...
           // var_dump($ray);//end if num rows > 0
                }
...
//    // update the quantity in the products page by subtracting 1 where the id was added
//    function updateQuantity(){
//        if(isset($_GET['id'])){
//        $id = $_GET['id'];
//        // query string that subtracts one from the quantity where the id is the ProductID
//        if($stmt = $this -> connection -> prepare("UPDATE Project1 SET Quantity=Quantity-1 WHERE ProductID=$id")){
//          $stmt -> execute();
//          $stmt -> store_result();
//            }   
//        }
//    }
    ...
    //attempt at removing $_GET variables from url
...
//        
//        $query = "SELECT * FROM Project1 LIMIT $start_from,$per_page";
